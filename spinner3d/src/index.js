...
function startRender() {
    ...
    loadTexture("src/res/laser.png")

    particleManager = new ParticleManager(1000, 5000);
    particleManager.setPosition(0.5, 0.5, 8.0);
    particleManager.setRandomColor();
    particleManager.setSpinDirection(1);

    particleManager2 = new ParticleManager(1000, 8000);
    particleManager2.setPosition(-0.5, -0.5, -3.0);
    particleManager2.setRandomColor();
    particleManager2.setSpinDirection(-1);

    particleManager3 = new ParticleManager(1000, 2000);
    particleManager3.setPosition(0.8, -0.2, -5.0);
